...
creates a global variable titled AuthToken. Instead of a user defining a "sub_key" and then calling that in every function in the package, 
...
function WMATA_auth(SubscriptionKey::String)
    ...
    global AuthToken = SubscriptionKey
end
